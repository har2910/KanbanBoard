...
const TicketList = ({ tickets, users }) => {
  ...
  const renderGroupedData = () => {
    ...
    return Object.entries(groupedData).map(([groupKey, groupTickets]) => (
      <div key={groupKey} className="ticket-list">
        <h2>{groupKey}</h2>
...
const App = () => {
  ...
  return <TicketList tickets={data.tickets} users={data.users} />;
};
